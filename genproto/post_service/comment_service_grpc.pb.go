...
type CommentServiceClient interface {
	...
	Delete(ctx context.Context, in *IdWithRequest, opts ...grpc.CallOption) (*Boosh, error)
}
...
func (c *commentServiceClient) Get(ctx context.Context, in *IdWithRequest, opts ...grpc.CallOption) (*Comment, error) {
	out := new(Comment)
...
func (c *commentServiceClient) GetAll(ctx context.Context, in *GetCommentQuery, opts ...grpc.CallOption) (*GetAllCommentsResult, error) {
	out := new(GetAllCommentsResult)
...
func (c *commentServiceClient) Delete(ctx context.Context, in *IdWithRequest, opts ...grpc.CallOption) (*Boosh, error) {
	out := new(Boosh)
...
type CommentServiceServer interface {
	...
	Delete(context.Context, *IdWithRequest) (*Boosh, error)
...
func (UnimplementedCommentServiceServer) GetAll(context.Context, *GetCommentQuery) (*GetAllCommentsResult, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAll not implemented")
}
func (UnimplementedCommentServiceServer) Update(context.Context, *Comment) (*Comment, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Update not implemented")
}
func (UnimplementedCommentServiceServer) Delete(context.Context, *IdWithRequest) (*Boosh, error) {
...
func _CommentService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommentServiceServer).Get(ctx, req.(*IdWithRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _CommentService_GetAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommentServiceServer).GetAll(ctx, req.(*GetCommentQuery))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _CommentService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommentServiceServer).Delete(ctx, req.(*IdWithRequest))
	}
	return interceptor(ctx, in, info, handler)
}
